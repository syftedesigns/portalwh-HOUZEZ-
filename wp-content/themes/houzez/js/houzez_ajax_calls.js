...
jQuery(document).ready(function ($) {
    ...
    if ( typeof HOUZEZ_ajaxcalls_vars !== "undefined" ) {
            ...
            var houzezOSMTileLayer = function() {
                ...
                if(is_mapbox == 'mapbox' && api_mapbox != '') {
                    ...
                    var tileLayer = L.tileLayer( 'https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token='+api_mapbox, {
                        attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMapx</a> contributors',
                        maxZoom: 18,
                        id: 'mapbox.streets',
        ...
        // Carlos Estarita, aqui edite los console
            ...
            $.ajax({
                ...
                success: function ( res ) {
                    ...
                    if( res.success ) {
                        ...
                        window.location.href = './complete-order/?selected_package=15166';
