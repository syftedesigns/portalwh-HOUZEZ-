...
<div class="<?php echo esc_attr($class_tooltip); ?> fade">
    ...
    <a target="_blank" href="<?php if(wp_is_mobile()){echo 'whatsapp://send?text=';} else { echo 'https://web.whatsapp.com://send?text=';} echo  get_the_title() .  '&nbsp;' . get_the_permalink();?>"><i class="fa fa-whatsapp"></i></a>

    <?php
    echo '
    <a href="http://www.facebook.com/sharer.php?u=' . urlencode(get_permalink()) . '" onclick="window.open(this.href, \'mywin\',\'left=50,top=50,width=600,height=350,toolbar=0\'); return false;"><i class="fa fa-facebook"></i></a>
