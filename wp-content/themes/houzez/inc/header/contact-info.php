...
<div class="header-contact">
        ...
        <div class="contact-block pull-right">
            <div class="media">
                ...
                <div class="media-body">
                    <p class="media-heading"><?php echo esc_attr( $timing_hours ); ?></p>
    ...
    <div class="contact-block pull-right">
        <div class="media">
            ...
            <?php } ?>
            <div class="media-body">
                <p class="media-heading"><?php echo esc_attr( $address_line1 ); ?></p>
    ...
    <?php if( houzez_option('hd2_contact_info') != '0' ){ ?>
        <div class="contact-block pull-right">
            <div class="media">
                ...
                <?php } ?>
                <div class="media-body">
                    <p class="media-heading"><?php echo esc_attr( $contact_phone ); ?></p>
