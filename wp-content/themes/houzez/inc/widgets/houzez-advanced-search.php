...
if( !function_exists('houzez_advanced_search_widget') ) {
    function houzez_advanced_search_widget()
    {
        ...
        $location = $type = $status = $state = $searched_country = $area = $label = $keyword = '';
        ...
        if (isset($_GET['country'])) {
            $searched_country = esc_attr($_GET['country']);
        }
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control"
                                               value="<?php echo isset ($_GET['property_id']) ? esc_attr($_GET['property_id']) : ''; ?>"
                                               name="property_id"
                                                        ...
                                                        <div class="col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                foreach ($options as $key => $val) {
                                                                    ...
                                                                    $get_field_name = sanitize_text_field($get_field_name);
