                                    ...
                                    <ul class="detail-amenities-list">
                                        <li class="media">
                                            <?php if( !empty($icon_rooms) ) { ?>
                                                <div class="media-left media-middle"><img src="<?php echo esc_url($icon_rooms); ?>" width="50" height="50" alt="Icon"></div>
                                            <?php } ?>
                                        ...
                                        <li class="media">
                                            ...
                                            <?php } ?>
                                            <div class="media-body media-middle"> <?php esc_html_e( 'Size:', 'houzez' ); ?><br> <?php //echo houzez_get_area_size( $plan['fave_plan_size'] ).' '.houzez_get_size_unit( '' ); 
                                            echo esc_attr( $plan['fave_plan_size'] ); ?> </div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
