...
// aqui voy a editar tambien, Carlos Estarita
/* -----------------------------------------------------------------------------------------------------------
...
if( !function_exists('houzez_listing_set_to_expire') ):
    function houzez_listing_set_to_expire($post_id){
        $prop = array(
            'ID'            => $post_id,
            'post_type'     => 'property',
            'post_status'   => 'expired' // Expired -> a publish
        );
...
// Carlos Estarita, aqui anulamos el expired
    ...
    function houzez_downgrade_package( $user_id, $pack_id ) {
        ...
        while( $query->have_posts()){
            ...
            $property = array(
                'ID'          => $post->ID,
                'post_type'   => 'property',
                'post_status' => 'expired' // cambiar a publish -> default expired, carlos Estarita
            );
...
if( !function_exists('houzez_resend_for_approval') ) {
    ...
    function houzez_resend_for_approval()
    {
        ...
        // Añadimos ! para negar la condicional, de esta forma será infinito los listing
        // Carlos Estarita
