    ...
    function houzez_submit_listing($new_property) {
        ...
        if( $submission_action == 'add_property' ) {
            ...
            if( $prop_id > 0 ) {
                ...
                // Aqui para anular el redirect
                if( $enable_paid_submission == 'membership'){ 
                    // houzez_update_package_listings( $userID );  DOCUMENTAMOS ESTO, REMOVER SI SE QUEIRE AÑADIR LISTING 
