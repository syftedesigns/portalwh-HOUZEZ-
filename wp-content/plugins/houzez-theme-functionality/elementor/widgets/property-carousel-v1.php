...
/**
 * Elementor Properties Carousel v1 Widget.
 * @since 1.5.6
 */
class Houzez_Elementor_Properties_Carousels_v1 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Property Carousel v1', 'houzez-theme-functionality' );
    }
    ...
    protected function render() {
        ...
        $args['slides_meta_position'] = $settings['slides_meta_position'];
        ...
        if( function_exists( 'houzez_prop_carousel' ) ) {
            echo houzez_prop_carousel( $args );
        }
        ...
        if ( Plugin::$instance->editor->is_edit_mode() ) : 
            ...
            <script>
                jQuery('.carousel[id^="properties-carousel-v1-"]').each(function(){
                    var $div = jQuery(this);
                    var token = $div.data('token');
                    var obj = 'prop_carousel_' + token;

                    var slidesToShow = <?php echo $settings['slides_to_show']; ?>,
                    ...
                    var faveOwl = jQuery('#properties-carousel-v1-'+token);
...
Plugin::instance()->widgets_manager->register_widget_type( new Houzez_Elementor_Properties_Carousels_v1 );